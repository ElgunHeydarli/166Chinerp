...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.document-type.create') }}" class="addSettingLink">
                ...
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($document_types as $document_type)
                            <tr data-id="{{ $document_type->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $document_type->name }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $document_type->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $document_type->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.document-type.edit', $document_type->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.document-type.destroy', $document_type->id) }}"
...
@push('css')
    <style>
        .setting_content .settingTable .settingTable-table table tbody tr td .settingTable-operation .settingTable-operation-links.activeModal {
            height: max-content;
        }
    </style>
@endpush
