...
@section('content')
    <div class="setting_content">
        <div class="tabContent-head">
            <a href="{{ route('admin.price-type.create') }}" class="addSettingLink">
                ...
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($price_types as $price_type)
                            <tr data-id="{{ $price_type->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $price_type->name }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $price_type->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $price_type->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.price-type.edit', $price_type->id) }}"
                                            ...
                                            <button data-href="{{ route('admin.price-type.destroy', $price_type->id) }}"
