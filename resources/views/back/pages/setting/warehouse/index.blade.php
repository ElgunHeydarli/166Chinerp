...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Anbarlar</h2>
        <a href="{{ route('admin.warehouse.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($warehouses as $warehouse)
                            <tr data-id="{{ $warehouse->id }}">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $warehouse->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $warehouse->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation" onclick="get_active(this)">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button data-href="{{ route('admin.warehouse.destroy', $warehouse->id) }}"
