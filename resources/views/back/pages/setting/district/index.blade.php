...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Rayonlar</h2>
        <a href="{{ route('admin.district.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($districts as $district)
                            <tr data-id="{{ $district->id }}">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $district->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $district->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button data-href="{{ route('admin.district.destroy', $district->id) }}"
