...
@section('content')
    <div class="setting_content">
        <div class="tabContent-head">
            <a href="{{ route('admin.payment-term.create') }}" class="addSettingLink">
                ...
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($payment_terms as $payment_term)
                            <tr data-id="{{ $payment_term->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $payment_term->name }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $payment_term->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $payment_term->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.payment-term.edit', $payment_term->id) }}"
                                            ...
                                            <button data-href="{{ route('admin.payment-term.destroy', $payment_term->id) }}"
