...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.car-type.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($car_types as $car_type)
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $car_type->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $car_type->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.car-type.edit', $car_type->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.car-type.destroy', $car_type->id) }}"
