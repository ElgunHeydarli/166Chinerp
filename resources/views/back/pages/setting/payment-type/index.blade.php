...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.payment-type.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($payment_types as $payment_type)
                            <tr data-id="{{ $payment_type->id }}">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $payment_type->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $payment_type->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.payment-type.edit', $payment_type->id) }}"
                                            ...
                                            <button data-href="{{ route('admin.payment-type.destroy', $payment_type->id) }}"
