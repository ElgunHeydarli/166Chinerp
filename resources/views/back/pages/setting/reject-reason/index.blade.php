...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.reject-reason.create') }}" class="addSettingLink">
                ...
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($reject_reasons as $reject_reason)
                            <tr data-id="{{ $reject_reason->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $reject_reason->name }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $reject_reason->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $reject_reason->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.reject-reason.edit', $reject_reason->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.reject-reason.destroy', $reject_reason->id) }}"
