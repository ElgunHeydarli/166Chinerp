...
@section('content')
    <div class="setting_content">
        <div class="tabContent-head">
            ...
            <a href="{{ route('admin.sector.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($sectors as $sector)
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $sector->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $sector->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button data-href="{{ route('admin.sector.destroy', $sector->id) }}"
