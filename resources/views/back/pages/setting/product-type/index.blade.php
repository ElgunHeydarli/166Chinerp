...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.product-type.create') }}" class="addSettingLink">
                ...
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($product_types as $product_type)
                            <tr data-id="{{ $product_type->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $product_type->name }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $product_type->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $product_type->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.product-type.edit', $product_type->id) }}"
                                            ...
                                            <button data-href="{{ route('admin.product-type.destroy', $product_type->id) }}"
