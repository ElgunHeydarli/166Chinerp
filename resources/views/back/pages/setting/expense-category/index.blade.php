...
@section('content')
    <div class="setting_content">
        <div class="tabContent-head">
            <a href="{{ route('admin.expense-category.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($expense_categories as $expense_category)
                            <tr data-id="{{ $expense_category->id }}">
                                ...
                                <td>
                                    <label class="switch">
                                        <input category="checkbox" {{ $expense_category->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $expense_category->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        <button class="settingTable-operation-btn" category="button">
                                            Əməliyyat
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.expense-category.edit', $expense_category->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.expense-category.destroy', $expense_category->id) }}"
    ...
    <div class="delete_settingModal_container">
        <div class="delete_settingModal">
            ...
            <button class="closeSettingModal" category="button">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
