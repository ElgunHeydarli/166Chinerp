...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Şöbələr</h2>
        <div class="tabContent-head">
            <a href="{{ route('admin.branch.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($branches as $branch)
                            <tr data-id="{{ $branch->id }}">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $branch->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $branch->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button data-href="{{ route('admin.branch.destroy', $branch->id) }}"
