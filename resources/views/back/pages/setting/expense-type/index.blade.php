...
@section('content')
    <div class="setting_content">
        <div class="tabContent-head">
            <a href="{{ route('admin.expense-type.create') }}" class="addSettingLink">
                ...
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($expense_types as $expense_type)
                            <tr data-id="{{ $expense_type->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $expense_type->name }}</td>
                                <td>{{ $expense_type->service?->name ?? 'Yoxdur' }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $expense_type->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $expense_type->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.expense-type.edit', $expense_type->id) }}"
                                            ...
                                            <button data-href="{{ route('admin.expense-type.destroy', $expense_type->id) }}"
