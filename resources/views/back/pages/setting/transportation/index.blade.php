...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Daşınmalar</h2>
        <a href="{{ route('admin.transportation.create') }}" class="addSettingLink">
                ...
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($transportations as $transportation)
                            <tr data-id="{{ $transportation->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $transportation->name }}</td>
                                <td>{{ $transportation->transportation_service->transporation_type->name }}</td>
                                <td>{{ $transportation->transportation_service->name }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $transportation->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $transportation->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button
                                                data-href="{{ route('admin.transportation.destroy', $transportation->id) }}"
