...
@section('content')
    <div class="create-draftOrder-container">
        <h2 style="margin-bottom:25px; font-size:28px;">Daşınma növü əlavə et</h2>
        <form method="POST" action="{{ route('admin.transportation-type.store') }}" class="create-draftOrder">
            @csrf
