...
@section('content')
    <div class="create-draftOrder-container">
        <h2 style="margin-bottom:25px; font-size:28px;">İcazə əlavə et</h2>
        <form method="POST" action="{{ route('admin.permission.store') }}" class="create-draftOrder">
            @csrf
            <div class="draftOrder-form">
                ...
                <div class="form-item">
                    ...
                    <input type="text" name="group_name" value="{{ old('group_name') }}" placeholder="Text here...">
                </div>
                <div class="form-item">
