...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.container-type.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($container_types as $container_type)
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $container_type->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $container_type->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.container-type.edit', $container_type->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.container-type.destroy', $container_type->id) }}"
