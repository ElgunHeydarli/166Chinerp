...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Təhsil pillələri</h2>
        <div class="tabContent-head">
            <a href="{{ route('admin.education.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($educations as $education)
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $education->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $education->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button data-href="{{ route('admin.education.destroy', $education->id) }}"
