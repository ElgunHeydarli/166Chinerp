...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Ölkələr</h2>
        <div class="tabContent-head">
            <a href="{{ route('admin.country.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($countries as $country)
                            <tr data-id="{{ $country->id }}">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $country->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $country->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button data-href="{{ route('admin.country.destroy', $country->id) }}"
