...
@section('content')
    <div class="setting_content">
        <div class="tabContent-head">
            ...
            <a href="{{ route('admin.station.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($stations as $station)
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $station->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $station->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.station.edit', $station->id) }}"
                                            ...
                                            <button data-href="{{ route('admin.station.destroy', $station->id) }}"
