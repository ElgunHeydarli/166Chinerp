...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.incoterm.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($incoterms as $incoterm)
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $incoterm->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $incoterm->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.incoterm.edit', $incoterm->id) }}"
                                            ...
                                            <button data-href="{{ route('admin.incoterm.destroy', $incoterm->id) }}"
