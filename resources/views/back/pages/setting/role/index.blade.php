...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Rollar</h2>
        <div class="tabContent-head">
            <a href="{{ route('admin.role.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($roles as $role)
                            <tr data-id="{{ $role->id }}">
                                ...
                                <td>
                                    <label class="switch">
                                        <input onchange="change_status(this,{{ $role->id }},'role')" type="checkbox"
                                            {{ $role->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $role->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.role.assign-permission', $role->id) }}"
                                                class="settingTable-operation-link">
                                            ...
                                            <button data-href="{{ route('admin.role.destroy', $role->id) }}"
