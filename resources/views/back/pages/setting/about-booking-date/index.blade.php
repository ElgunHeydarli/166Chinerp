...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Təxmini rezervasiya tarixləri</h2>
        <div class="tabContent-head">
            <a href="{{ route('admin.about-booking-date.create') }}" class="addSettingLink">
        ...
        <div class="settingTable">
            <div class="settingTable-table">
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($about_booking_dates as $about_booking_date)
                            <tr data-id="{{ $about_booking_date->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $about_booking_date->date->format('d/m/Y') }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $about_booking_date->status ? 'checked' : '' }}>
                                ...
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.about-booking-date.edit', $about_booking_date->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.about-booking-date.destroy', $about_booking_date->id) }}"
