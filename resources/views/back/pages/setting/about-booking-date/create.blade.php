...
@section('content')
    <div class="create-draftOrder-container">
        <h2 style="margin-bottom:25px; font-size:28px;">Təxmini rezervasiya tarixi əlavə et</h2>
        <form method="POST" action="{{ route('admin.about-booking-date.store') }}" class="create-draftOrder">
            @csrf
            <div class="draftOrder-form">
                <div class="form-item">
                    <label for="">Tarix</label>
                    <input type="text" class="datetimepicker" autocomplete="off" name="date" value="{{ old('date') }}"
                        placeholder="Tarix">
