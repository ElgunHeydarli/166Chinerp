...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.customs-clearance.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($customs_clearances as $customs_clearance)
                            <tr>
                                ...
                                <td>{{ $customs_clearance->name }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $customs_clearance->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $customs_clearance->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.customs-clearance.edit', $customs_clearance->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.customs-clearance.destroy', $customs_clearance->id) }}"
