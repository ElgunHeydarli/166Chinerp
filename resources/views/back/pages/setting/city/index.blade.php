...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Şəhərlər</h2>
        <div class="tabContent-head">
            <a href="{{ route('admin.city.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($cities as $city)
                            <tr data-id="{{ $city->id }}">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $city->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $city->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation" onclick="get_active(this)">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button data-href="{{ route('admin.city.destroy', $city->id) }}"
