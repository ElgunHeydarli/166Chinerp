...
@section('content')
    <div class="create-draftOrder-container">
        <h2 style="margin-bottom:25px; font-size:28px;">Konteyner yoxlama səbəbi əlavə et</h2>
        <form method="POST" action="{{ route('admin.container-check-reason.store') }}" class="create-draftOrder">
            @csrf
