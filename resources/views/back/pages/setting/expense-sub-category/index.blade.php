...
@section('content')
    <div class="setting_content">
        <div class="tabContent-head">
            <a href="{{ route('admin.expense-sub-category.create') }}" class="addSettingLink">
                ...
                <table id="sortable-table">
                    ...
                    <tbody>
                        @foreach ($expense_sub_categories as $expense_sub_category)
                            <tr data-id="{{ $expense_sub_category->id }}">
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $expense_sub_category->name }}</td>
                                <td>{{ $expense_sub_category->category?->name ?? 'Yoxdur' }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $expense_sub_category->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $expense_sub_category->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.expense-sub-category.edit', $expense_sub_category->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.expense-sub-category.destroy', $expense_sub_category->id) }}"
