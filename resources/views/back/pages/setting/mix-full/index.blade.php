...
@section('content')
    <div class="setting_content">
        <a href="{{ route('admin.mix-full.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($mix_fulles as $mix_full)
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" {{ $mix_full->status ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                                <td>{{ $mix_full->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.mix-full.edit', $mix_full->id) }}"
                                            ...
                                            <button
                                                data-href="{{ route('admin.mix-full.destroy', $mix_full->id) }}"
