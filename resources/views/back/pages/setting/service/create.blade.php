...
@section('content')
    <div class="create-draftOrder-container">
        <form method="POST" action="{{ route('admin.service.store') }}" class="create-draftOrder">
            @csrf
                    ...
                    <div class="group-container">
                        <div class="group">
                            <div class="group-title">
                                <input type="checkbox" name="detail_name[]" value="expense_type" id="expense_type">
                                <label for="expense_type">Xərc növü</label>
                            </div>
                        </div>
                        <div class="group">
                            <div class="group-title">
                                <input type="checkbox" name="detail_name[]" value="document_type" id="document_type">
                                <label for="document_type">Sənəd növü</label>
                            </div>
                        </div>
                        <div class="group">
                            <div class="group-title">
                                <input type="checkbox" name="detail_name[]" value="start_date" id="start_date">
                                <label for="start_date">Başlama tarixi</label>
                            </div>
                        </div>
                        <div class="group">
                            <div class="group-title">
                                <input type="checkbox" name="detail_name[]" value="end_date" id="end_date">
                                <label for="end_date">Bitmə tarixi</label>
                            </div>
                        </div>
                        <div class="group">
                            <div class="group-title">
                                <input type="checkbox" name="detail_name[]" value="note" id="note">
