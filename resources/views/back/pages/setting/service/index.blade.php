...
@section('content')
    <div class="setting_content">
        <div class="tabContent-head">
            ...
            <a href="{{ route('admin.service.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($services as $service)
                            <tr>
                                ...
                                <td>{{ $service->created_at?->format('d.m.Y') ?? 'Yoxdur' }}</td>
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            ...
                                            <button data-href="{{ route('admin.service.destroy', $service->id) }}"
...
@push('css')
    <style>
        .setting_content
         .settingTable
          .settingTable-table table tbody tr td .settingTable-operation .settingTable-operation-links.activeModal {
            height: max-content;
        }
    </style>
@endpush
