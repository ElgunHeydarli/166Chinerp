<!--======================== Modal ========================-->
<div class="unclaimedCargo_modal_container">
    <div class="unclaimedCargo_modal">
        <button class="close_unclaimedCargo_modal" type="button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 6L6 18M6 6L18 18" stroke="black" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
            </svg>
        </button>
        <form action="{{ route('admin.abandoned-cargo.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-item">
                <label for="">Anbara daxil olma tarixi</label>
            ...
            <div class="form-uploads">
                <div class="form-upload-item">
                    <h3>Üzərindəki əlavə məlumatlar</h3>
            ...
            <button class="add_unclaimedCargo_btn" type="submit">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
