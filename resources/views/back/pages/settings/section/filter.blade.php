    ...
    <tbody>
        @foreach ($settings as $setting)
            <tr>
                ...
                <td>{{ $setting->value_zh }}</td>
                <td>
                    <div class="settingTable-operation">
                        <button class="settingTable-operation-btn" onclick="open_settings(this)" type="button">
                            Əməliyyat
                        ...
                        <div class="settingTable-operation-links">
                            ...
                            <button data-href="{{ route('admin.setting.destroy', $setting->id) }}"
...
{{ $settings->withQueryString()->links('back.section.pagination') }}
