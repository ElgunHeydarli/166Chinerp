<div class="responsible_person_item">
    <div class="form-item">
        <label for="">
            Ad soyad
        </label>
        <input type="text" name="person_name[]" oninput="convert_letter(this)"
            value="{{ isset($responsible_person) ? $responsible_person->name : '' }}" required placeholder="text here">
    </div>
    <div class="form-item">
        <label for="">
            Əlaqə nömrəsi
        </label>
        <input type="text" name="person_phone[]" oninput="convert_numeric(this)"
            value="{{ isset($responsible_person) ? $responsible_person->phone : '' }}" required placeholder="text here">
    </div>
    <button type="button" onclick="delete_person(this)" class="removeResponsiblePerson">
