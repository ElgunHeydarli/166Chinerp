<div class="reject_container_modal_container">
    <div class="reject_container_modal">
        <div class="modal-top">
            <h2>İmtina</h2>
            <button class="closeRejectContainerModal" type="button">
        ...
        <form action="" method="POST">
            ...
            <div class="form-item">
                ...
                <select name="reject_reason_id" class="nice-select" id="">
            ...
            <button class="reject_submitBtn" type="submit">İmtina et</button>
        </form>
    </div>
</div>
