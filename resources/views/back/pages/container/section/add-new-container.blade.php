<div class="addContainerForm">
    <div class="form-line">
        <div class="form-item">
            ...
            <select class="nice-select" name="purchase_type[]" id="">
                ...
                <option value="purchase">{{ trns('purchase') }}</option>
                <option value="rent">{{ trns('rent') }}</option>
            </select>
        ...
        <div class="form-item">
            <label for="">{{ trns('purchase_date') }}<span>*</span></label>
            <input type="text" name="purchase_date[]" autocomplete="off" class="datetimepicker"
        ...
        <div class="form-item">
            ...
            <select class="nice-select" name="container_type_id[]" id="">
                ...
                @foreach ($container_types as $container_type)
                    <option value="{{ $container_type->id }}">{{ $container_type->name }}</option>
                @endforeach
            </select>
            <button class="resetSelectBtn" type="button">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <div class="form-item">
            ...
            <input type="text" name="count[]" placeholder="Selected">
        </div>
        <div class="form-item price">
            <label for="">{{ trns('price') }}<span>*</span></label>
            <input type="text" name="price[]" placeholder="Selected">
        </div>
        ...
        <div class="form-item lastPayment">
            <input type="text" class="datetimepicker" name="last_payment_date[]" autocomplete="off"
    ...
    @can('Yeni Konteynerlər page-Konteyner şəkilləri Upload')
        <div class="uploadImages-container">
            <div class="imgFile">
                <div class="icon">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                        ...
                        <path
                            ...
                            stroke="#00A3E8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M32 32L24 24L16 32" stroke="#00A3E8" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                    </svg>
                </div>
                ...
                <input type="file" name="images[]" onchange="file_upload(this)" multiple>
            </div>
    ...
    @endcan
    <button type="button" onclick="delete_item(this)" class="deleteContainerInfo">
        {{ trns('delete') }}
