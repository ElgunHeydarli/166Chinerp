<div class="containerImgModal_container">
    <div class="containerImgModal">
        <h2>Konteyner şəkli yüklə</h2>
        <button class="closeContainerImgModal" type="button">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="containerImgFile">
                ...
                <div class="containerImgFile-body">
            ...
            <div class="containerImgFiles">

            </div>

            <button class="save_containerImg" type="submit">Save</button>
        </form>
    </div>
</div>
