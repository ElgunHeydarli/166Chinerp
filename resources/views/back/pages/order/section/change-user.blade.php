<div class="chineReserved_modal_container" id="change-user-modal">
    <div class="chineReserved_modal">
        <h2>Kuratoru dəyiş</h2>
        <button class="closeChineReservedModal" onclick="close_user_change_modal()" type="button">
        ...
        <form action="" method="POST">
            @csrf
            <div class="form-items" style="grid-template-columns: repeat(1,1fr);">
                <div class="form-item">
                    <label for="">
                        Kurator
                    </label>
                    <select name="user_id" class="select2" id="">
