<div class="chineReserved_modal_container" id="booking-modal">
    <div class="chineReserved_modal" style="max-width:950px;">
        <h2>Rezervasiya</h2>
        <button class="closeChineReservedModal" onclick="close_booking_modal(this)" type="button">
        ...
        <form action="" method="POST">
            @csrf
            <div class="form-items" style="grid-template-columns: repeat(3, 1fr)">
                <input type="hidden" class="allowed-dates" value="{{ implode(',', $booking_dates) }}">
                <div class="form-item">
                    <label for="">
                        Rezervasiya tarixi
                    </label>
                    <input type="text" autocomplete="off" name="date" class="booking-datepicker"
                        placeholder="Tarix">
                ...
                <div class="form-item">
                    ...
                    <select name="container_type_id" onchange="get_containers(this)" class="select2" id="">
                ...
                <div class="form-item">
                    ...
                    <select name="container_id" class="select2" id="">
                        <option value="">Seçin</option>
                        @foreach ($containers as $container)
                            <option value="{{ $container->id }}">{{ "$container->code ($container->empty_volume CBM)" }}
                            </option>
                        @endforeach
                    </select>
                    <button class="resetSelectBtn" type="button">
            ...
            <button class="chinaReserved_submitBtn" type="submit">Submit</button>
        </form>
    </div>
</div>
