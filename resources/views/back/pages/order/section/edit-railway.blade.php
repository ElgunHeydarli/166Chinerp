<div class="edit_railwayFileModal_container">
    <div class="edit_railwayFileModal">
        <h2>Railway bill düzəlt</h2>
        <button class="edit_closeRailwayFileModal" type="button">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="edit_railWayFile">
                ...
                <div class="edit_railWayFile-body">
            ...
            <div class="edit_railWayFile-fileUpload">
                ...
                <div class="edit_railWayFile-fileUpload-main">
                    <div class="edit_railWayFile-fileUpload-top">
                        <span class="edit_railWayFile-FileName">test.pdf</span>
            ...
            <button class="edit_raleWayBill" type="submit">Yadda saxla</button>
        </form>
    </div>
</div>
