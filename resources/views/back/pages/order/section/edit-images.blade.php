<div class="edit_containerImgModal_container">
    <div class="edit_containerImgModal">
        <h2>Konteyner şəkli düzəlt</h2>
        <button class="edit_closeContainerImgModal" type="button">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="edit_containerImgFile">
                <div class="icon">
                ...
                <div class="edit_containerImgFile-body">
            ...
            <div class="edit_containerImgFiles">

            </div>

            <button class="edit_containerImg" type="submit">Yadda saxla</button>
        </form>
    </div>
</div>
