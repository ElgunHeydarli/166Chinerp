<div class="edit_declarationFileModal_container">
    <div class="edit_declarationFileModal">
        <h2>Declaration düzəlt et</h2>
        <button class="edit_closeDeclarationFileModal" type="button">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="edit_declarationFile">
                <div class="icon">
                ...
                <div class="edit_declarationFile-body">
            ...
            <div class="edit_declarationFile-fileUpload">
                ...
                <div class="edit_declarationFile-fileUpload-main">
                    <div class="edit_declarationFile-fileUpload-top">
                        <span class="edit_declarationFile-FileName">test.pdf</span>
            ...
            <button class="edit_Declaration" type="submit">Yadda saxla</button>
        </form>
    </div>
</div>
