<div class="shortDeclarationFileModal_container" id="add-short-declaration">
    <div class="declarationFileModal">
        <h2>Qısa idxal bəyannaməsi yüklə</h2>
        <button class="closeDeclarationFileModal" type="button">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="declarationFile">
                ...
                <div class="declarationFile-body">
            ...
            <div class="declarationFile-fileUpload">
                <img src="{{ asset('back/assets') }}/images/pdfImg.svg" alt="">
                <div class="declarationFile-fileUpload-main">
                    <div class="declarationFile-fileUpload-top">
                        <span class="declarationFile-FileName"></span>
                        <p class="declarationFile-fileSize"></p>
                    </div>
                    <div class="declarationFile-fileProgress">
                        <div class="uploadLine"></div>
                    </div>
                </div>
                <button class="removeDeclarationFile" type="button">
            ...
            <button class="save_Declaration" type="submit">Save</button>
        </form>
    </div>
</div>
