<div class="railwayFileModal_container" id="add-handover">
    <div class="railwayFileModal">
        <h2>Təhvil təslim aktı yüklə</h2>
        <button class="closeRailwayFileModal" onclick="close_handover_modal(this)" type="button">
