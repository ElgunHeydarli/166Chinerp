<div class="reject_draftOrder_modal_container">
    <div class="reject_draftOrder_modal">
        <div class="modal-top">
            <h2>İmtina</h2>
            <button class="closeRejectOrderModal" type="button">
        ...
        <form method="POST">
            ...
            <div class="form-item">
                ...
                <select class="nice-select" name="reject_reason_id" id="">
