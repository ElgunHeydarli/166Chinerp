...
@section('content')
    <div class="setting_content">
        <h2 style="font-size: 28px; margin-bottom:25px;">Hüquqi müştərilər</h2>
        <div class="tabContent-head">
            <a href="{{ route('admin.company.create') }}" class="addSettingLink">
                    ...
                    <tbody>
                        @foreach ($customers as $customer)
                            <tr data-id="{{ $customer->id }}">
                                ...
                                <td>{{ $customer->voen }}</td>
                                <td>{{ $customer->source?->name ?? 'Yoxdur' }}</td>
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" onchange="change_status(this,{{ $customer->id }},'customer')" {{ $customer->status ? 'checked' : '' }}>
                                ...
                                <td>
                                    <div class="settingTable-operation">
                                        ...
                                        <div class="settingTable-operation-links">
                                            <a href="{{ route('admin.company.edit', $customer->id) }}"
                                            ...
                                            <button data-href="{{ route('admin.company.destroy', $customer->id) }}"
