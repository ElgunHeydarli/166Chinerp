<div class="setReservationTime_modal_container">
    <div class="setReservationTime_modal">
        <div class="modal-top">
            <h2>Konteynerin rezervasiya vaxtını təyin et</h2>
        ...
        <form action="{{ route('admin.booking-date.update-checking') }}" method="POST">
            @csrf
            ...
            <div class="form-item">
                ...
                <input type="text" autocomplete="off" name="booking_date" class="datetimepicker" placeholder="Tarix">
