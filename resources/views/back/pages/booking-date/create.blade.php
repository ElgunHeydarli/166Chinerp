...
@section('content')
    <div class="addReservationDate-container">
        ...
        <div class="head-title">
            ...
            <p>Rezerv olunma tarixi əlavə et</p>
        </div>
        <form action="{{ route('admin.booking-date.store') }}" method="POST" class="addReservationDate-form">
            @csrf
            <div class="form-items">
                <div class="form-item">
                    <label for="">Tarix <span>*</span></label>
                    <input type="text" name="date" autocomplete="off" value="{{ old('date') }}"
                ...
                <div class="form-item">
                    <label for="">Konteyner sayı <span>*</span></label>
                    <input type="text" name="count" value="{{ old('count') }}">
                </div>
                <div class="form-item">
                    <label for="">Ödəyici / Vendor <span>*</span></label>
                    ...
                    <select class="nice-select" name="container_type_id" onchange="get_price()" id="">
                        ...
                        @foreach ($container_types as $container_type)
                            <option value="{{ $container_type->id }}"
                                {{ old('container_type_id') == $container_type->id ? 'selected' : '' }}>
                ...
                <div class="form-item">
                    <label for="">Son ödəmə tarixi <span>*</span></label>
                    <input type="text" autocomplete="off" name="last_payment_date"
                        value="{{ old('last_payment_date') }}" class="datetimepicker" placeholder="Son ödəmə tarixi">
                    <div class="calendar-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="form-item">
                    <label for="">Cəmi <span>*</span></label>
                    <input type="text" name="total_price" value="{{ old('total_price') }}">
                </div>
            </div>
            <div class="form-buttons">
                <a href="" class="backLink">Geri</a>
                <button class="submitForm" type="submit">Təsdiq</button>
            </div>
        </form>
    </div>
@endsection
