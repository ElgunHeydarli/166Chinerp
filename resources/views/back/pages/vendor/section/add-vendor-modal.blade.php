<div class="addVendor_modal_container">
    <div class="addVendor_modal">
        <h2>Add Vendor</h2>
        <button class="closeVendorModal" type="button">
        ...
        <form method="POST" action="{{ route('admin.vendor.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-line">
                <div class="form-item">
                    <label for="">
                        Təchizatçı<span>*</span>
                    </label>
                    <select class="nice-select" name="customer_type" id="">
                ...
                <div class="form-item">
                    ...
                    <input type="text" name="role" value="{{ old('role') }}" placeholder="Text here...">
                </div>
                <div class="form-item">
                    <label for="">Contract start date</label>
                    <input type="text" autocomplete="off" name="start_date" value="{{ old('start_date') }}"
                ...
                <div class="form-item">
                    <label for="">Hüquqi ünvan</label>
                    <input type="text" name="legal_address" value="{{ old('legal_address') }}"
                        placeholder="Text here...">
                </div>
                <div class="form-item">
                    <label for="">Faktiki ünvan</label>
                    <input type="text" name="factical_address" value="{{ old('factical_address') }}"
                        placeholder="Text here...">
                </div>
                <div class="form-item">
                    <label for="">
                    ...
                    <input type="text" name="bank" value="{{ old('bank') }}" placeholder="Text here...">
                </div>
                <div class="form-item">
                    <label for="">Bank VÖEN</label>
                    <input type="text" name="bank_voen" value="{{ old('bank_voen') }}"
                        placeholder="Text here...">
                </div>
                <div class="form-item">
                    <label for="">Kod</label>
                ...
                <div class="form-item">
                    <label for="">Hesablaşma hesabı</label>
                    <input type="text" name="account" value="{{ old('account') }}" placeholder="Text here...">
                </div>
                <div class="form-item">
                    <label for="">Müxbir hesab</label>
                    <input type="text" name="agent_account" value="{{ old('agent_account') }}"
                        placeholder="Text here...">
                </div>
                <div class="form-item">
                    <label for="">SWIFT</label>
                    <input type="text" name="swift" value="{{ old('swift') }}" placeholder="Text here...">
                </div>
                <div class="form-item">
                    <label for="">Direktor</label>
                    <input type="text" name="director" value="{{ old('director') }}" placeholder="Text here...">
                </div>
            </div>
            ...
            <div class="vendor-fileUpload-area">
                ...
                <div class="vendor-fileUpload-main">
                    <div class="vendor-fileUpload-top">
                        <span class="vendor-FileName"></span>
                        <p class="vendor-fileSize"></p>
                    </div>
            ...
            <button class="save_vendor" type="submit">Save</button>
        </form>
    </div>
</div>
