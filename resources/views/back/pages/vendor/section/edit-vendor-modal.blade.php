<div class="editVendor_modal">
    <h2>Vendor düzəliş et</h2>
    <button class="closeEditVendorModal" onclick="close_vendor_edit_modal(this)" type="button">
    ...
    <form action="{{ route('admin.vendor.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-line">
            <div class="form-item">
                <label for="">
                    Müştəri növü<span>*</span>
                </label>
                <select name="customer_type" id="" class="nice-select">
                    <option value="">Select</option>
                    <option value="physical"
                        {{ $vendor->customer_type == \App\Enums\CustomerType::PHYSICAL ? 'selected' : '' }}>Fiziki
                    </option>
                    <option value="legal"
                        {{ $vendor->customer_type == \App\Enums\CustomerType::LEGAL ? 'selected' : '' }}>Hüquqi
                    </option>
                </select>
            ...
            <div class="form-item">
                ...
                <input type="text" name="vendor_name" value="{{ $vendor->vendor_name }}" placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                    Chinese name
                </label>
                <input type="text" name="chinese_name" value="{{ $vendor->chinese_name }}"
            ...
            <div class="form-item">
                ...
                <input type="text" name="role" value="{{ $vendor->role }}" placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                    Contract start date
                ...
                <input type="text" autocomplete="off" name="start_date"
                    value="{{ $vendor->start_date?->format('d.m.Y') }}" class="datetimepicker">
            ...
            <div class="form-item">
                ...
                <input type="text" name="end_date" autocomplete="off"
                    value="{{ $vendor->end_date?->format('d.m.Y') }}" class="datetimepicker">
                <div class="calendar-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="form-item">
                ...
                <input type="text" name="voen" value="{{ $vendor->voen }}" placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                    Hüquqi ünvan
                </label>
                <input type="text" name="legal_address" value="{{ $vendor->legal_address }}"
                    placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                ...
                <input type="text" name="factical_address" value="{{ $vendor->factical_address }}"
                    placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                ...
                <input type="text" name="bank" value="{{ $vendor->bank }}" placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                    Bank VÖEN
                </label>
                <input type="text" name="bank_voen" value="{{ $vendor->bank_voen }}" placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                    Kod
                </label>
                <input type="text" value="code" value="{{ $vendor->code }}" placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                    Hesablaşma hesabı
                </label>
                <input type="text" value="{{ $vendor->account }}" name="account" placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                    Müxbir hesab
                </label>
                <input type="text" name="agent_account" value="{{ $vendor->agent_account }}"
                    placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                ...
                <input type="text" name="swift" value="{{ $vendor->swift }}" placeholder="Text here...">
            </div>
            <div class="form-item">
                <label for="">
                    Direktor
                </label>
                <input type="text" name="director" value="{{ $vendor->director }}" placeholder="Text here...">
            </div>
        </div>
        ...
        @if (!is_null($vendor->file) && !empty($vendor->file->file))
            <div class="vendor-fileUpload-area">
                <img src="{{ asset('back/assets') }}/images/pdfImg.svg" alt="">
                <div class="vendor-fileUpload-main">
                    <div class="vendor-fileUpload-top">
                        <span class="vendor-FileName">{{ explode('/', $vendor->file?->file)[2] }}</span>
                        <p class="vendor-fileSize">5 Mb</p>
                    </div>
                    <div class="vendor-fileProgress">
                        <div class="uploadLine"></div>
                    </div>
                </div>
                <button class="removeVendorFile" type="button">
        ...
        <button class="save_Editvendor" type="submit">Save</button>
    </form>
</div>
