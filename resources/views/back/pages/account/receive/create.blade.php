...
@section('content')
    <div class="addReceivable-container">
        ...
        <form action="{{ route('admin.receive.store') }}" method="post" class="addReceivable-form">
            @csrf
            <div class="form-line">
                <div class="form-item">
                    <label for=""> İnvoice İD </label>
                    <input type="text" name="invoice_id" oninput="convert_alphanumeric(this)"
                        value="{{ old('invoice_id') }}" placeholder="text here" />
                </div>
                <div class="form-item">
                    <label for="">LOG</label>
                ...
                <div class="form-item">
                    ...
                    <input type="text" name="service_name" oninput="convert_letter(this)"
                        value="{{ old('service_name') }}" placeholder="text here" />
                </div>
                <div class="form-item">
                    <label for=""> İnvoice tarixi </label>
                    <input type="text" name="invoice_date" value="{{ old('invoice_date') }}" class="datetimepicker"
                ...
                <div class="form-item">
                    ...
                    <input type="text" name="last_payment_date" value="{{ old('last_payment_date') }}"
                        autocomplete="off" class="datetimepicker" placeholder="Tarix" />
                    <div class="calendar-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <select name="currency" id="" class="nice-select">
                        ...
                        @foreach ($currencies as $currency)
                            <option value="{{ $currency->code }}"
                                {{ old('currency') == $currency->code ? 'selected' : '' }}>{{ $currency->code }}
                            </option>
                        @endforeach
                    </select>
            ...
            <button class="submitAddReceivable" type="submit">Təsdiq</button>
        </form>
    </div>
@endsection
