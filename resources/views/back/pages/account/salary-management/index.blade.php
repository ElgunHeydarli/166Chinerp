    ...
    <div class="finance_tab_content">
        <div class="tabContent-head">
            ...
            <div class="filterColumns">
                <input type="text" class="datetimepicker" onchange="filter()" name="start_date" value="{{ request('start_date') }}"
            ...
            <div class="filterColumns">
                <input type="text" class="datetimepicker" onchange="filter()" name="end_date" value="{{ request('end_date') }}"
        ...
        <div class="finance_tabContent_inner">
            ...
            <div class="empPayTable">
                @include('back.pages.account.salary-management.filter', [
...
@push('js')
    ...
    <script>
        function filter(page = 1) {
            ...
            let newUrl = `/salary-management?${params.toString()}`;
            let url = `/salary-management/filter?${params.toString()}`;
            ...
            fetch(url)
                ...
                .then(data => {
                    if (data.status == 'success') {
                        let empPayTable = document.querySelector('.empPayTable');
                        empPayTable.innerHTML = data.view;
                    }
                });
        }
    </script>
