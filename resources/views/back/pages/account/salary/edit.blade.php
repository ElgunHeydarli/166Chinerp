...
@section('content')
    <div class="editEmployee-container">
        ...
        <form action="{{ route('admin.salary.update', $user->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="form-box">
                <div class="form-line">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" name="firstname" oninput="convert_letter(this)" value="{{ $user->firstname }}"
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" name="lastname" oninput="convert_letter(this)" value="{{ $user->lastname }}"
                            placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                        ...
                        <input type="text" name="fin" oninput="convert_alphanumeric(this)"
                            value="{{ $user->fin }}" placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                            Rol
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" name="position" oninput="convert_letter(this)" value="{{ $user->position }}"
                            placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                        ...
                        <input type="text" name="mmc" oninput="convert_letter(this)" value="{{ $user->mmc }}"
                            placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                        ...
                        <input type="text" name="email" value="{{ $user->email }}" placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                            Parol
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" name="phone" oninput="convert_numeric(this)" value="{{ $user->phone }}"
                            placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                    ...
                    <div class="form-item">
                        ...
                        <select name="education_id" id="" class="nice-select">
                            ...
                            @foreach ($educations as $education)
                                <option value="{{ $education->id }}" {{ $user->education_id == $education->id }}>
                        ...
                        <select name="branch_id" id="" class="nice-select">
                            ...
                            @foreach ($branches as $branch)
                                <option value="{{ $branch->id }}"
                                    {{ $user->branch_id == $branch->id ? 'selected' : '' }}>{{ $branch->name }}</option>
                            @endforeach
                        </select>
                        <button class="resetSelectBtn" type="button">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <select name="country_id" id="" class="nice-select">
                            ...
                            @foreach ($countries as $country)
                                <option value="{{ $country->id }}"
                                    {{ $user->country_id == $country->id ? 'selected' : '' }}>{{ $country->name }}
                                </option>
                            @endforeach
                        </select>
                        <button class="resetSelectBtn" type="button">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" name="gross_salary" oninput="convert_numeric(this)"
                            value="{{ $user->gross_salary }}" placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                            Nəğd
                        </label>
                        <input type="text" name="cash" oninput="convert_numeric(this)"
                            value="{{ $user->cash }}" placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                            Bank
                        </label>
                        <input type="text" name="bank" oninput="convert_alphanumeric(this)"
                            value="{{ $user->bank }}" placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                            Hökumət ödənişləri
                        ...
                        <input type="text" name="government_payment" oninput="convert_numeric(this)"
                            value="{{ $user->government_payment }}" placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                            Net ə/h
                        </label>
                        <input type="text" name="net_salary" oninput="convert_numeric(this)"
                            value="{{ $user->net_salary }}" placeholder="text here">
                    </div>
                    <div class="form-item">
                        <label for="">
                            Valyuta
                        ...
                        <select name="currency" id="" class="nice-select">
                            ...
                            @foreach ($currencies as $currency)
                                <option value="{{ $currency->code }}"
                                    {{ $user->currency == $currency->code ? 'selected' : '' }}>{{ $currency->code }}
                                </option>
                            @endforeach
                        </select>
                        <button class="resetSelectBtn" type="button">
                    ...
                    <div class="form-item">
                        ...
                        <select name="status" id="" class="nice-select">
                            <option value="1" {{ $user->status == 1 ? 'selected' : '' }}>İşləyir</option>
                            <option value="0" {{ $user->status == 0 ? 'selected' : '' }}>İşləmir</option>
                        </select>
                        <button class="resetSelectBtn" type="button">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" autocomplete="off" name="start_date"
                            value="{{ $user->start_date?->format('d.m.Y') }}" class="datetimepicker"
                            placeholder="Tarix">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" autocomplete="off" name="end_date"
                            value="{{ $user->end_date?->format('d.m.Y') }}" class="datetimepicker" placeholder="Tarix">
                        <div class="calendar-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="edit_employeeFile-container">
                    <div class="edit_employeeFile-box">
                        <div class="icon">
                        ...
                        <div class="edit_employeeFile-body">
                    ...
                    <div class="edit_employeeFile-fileUpload">
                        @if ($user->image)
                            <div class="edit_employeeFile-fileUpload-area">
                                <img src="{{ asset($user->image) }}" alt="">
                                <div class="edit_employeeFile-fileUpload-main">
                                    <div class="edit_employeeFile-fileUpload-top">
                                        <span
                                            class="edit_employeeFile-FileName">{{ explode('/', $user->image)[2] }}</span>
                                        <p class="edit_employeeFile-fileSize">5 MB</p>
                                    </div>
