    ...
    <div class="finance_tab_content">
        <div class="tabContent-head">
            ...
            <div class="filterColumns">
                <input type="text" class="datetimepicker" name="start_date" value="{{ request('start_date') }}"
                    oninput="filter()" placeholder="Start Time" />
            ...
            <div class="filterColumns">
                <input type="text" class="datetimepicker" name="end_date" value="{{ request('end_time') }}"
                    oninput="filter()" placeholder="End Time" />
                <div class="calendar-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <a href="{{ route('admin.salary.create') }}" class="addEmployeeLink">
        ...
        <div class="finance_tabContent_inner">
            ...
            <div class="employeeTable">
                @include('back.pages.account.salary.section.filter', ['users' => $users])
            </div>
        </div>
    </div>
@endsection
...
@push('js')
    ...
    <script>
        function filter(page = 1) {
            ...
            let newUrl = `/salary?${params.toString()}`;
            let url = `/salary/filter?${params.toString()}`;
            ...
            fetch(url)
                ...
                .then(data => {
                    if (data.status == 'success') {
                        ...
                        employeeTable.innerHTML = data.view;
                    }
                });
        }
    </script>
