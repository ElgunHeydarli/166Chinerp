...
@section('content')
    <div class="finance_tab_content">
        <div class="tabContent-head">
            ...
            <a href="addBulkPayment.html" class="addBulkPaymentLink">
        ...
        <div class="finance_tabContent_inner">
            ...
            <div class="bulkPaymentTable">
                @include('back.pages.account.bulk-payment.section.filter', [
...
@push('js')
    ...
    <script>
        function filter(page = 1) {
            ...
            let newUrl = `/bulk-payment?${params.toString()}`;
            let url = `/bulk-payment/filter?${params.toString()}`;
            ...
            fetch(url)
                ...
                .then(data => {
                    if (data.status == 'success') {
                        let bulkPaymentTable = document.querySelector('.bulkPaymentTable');
                        bulkPaymentTable.innerHTML = data.view;
                    }
                });
        }
    </script>
